...
//  Version of DHTNEW library.
#define DHTNEW_LIB_VERSION                (F("0.4.19"))


//  Return values for DHTNEW::read()
#define DHTLIB_OK                         0
...
//  DHTNEW implements a DHT11/DHT22 sensor.
//  It uses the pin to read the data.
class DHTNEW
{
public:

  //  Constructor for DHTNEW.
  //  Sets pin to input and sets the dataPin to the given pin.
  DHTNEW(uint8_t pin);
